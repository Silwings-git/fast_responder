...
public class ResponderBodyArgumentResolver implements HandlerMethodArgumentResolver {
     ...
     */
    private Object getParameter(String parameterName, ResponderBody responderBody) {
        if (null == responderBody) {
            return null;
        }
        PropertyDescriptor propertyDescriptor = BeanUtils.getPropertyDescriptor(responderBody.getClass(), parameterName);
...
//        final Map<String, ? super Object> parameters = responderBody.getParameters();
