...
1. 创建并启用应答器
   ...
   ![输入图片说明](src/docs/images/1642343289387.png)

   ![1642343524290](src/docs/images/1642343524290.png)

   ![1642347203609](src/docs/images/1642346203911.png)

   ![1642347272450](src/docs/images/1642346284473.png)

   ![1642343787434](src/docs/images/1642343787434.png)

   ![1642344847804](src/docs/images/1642344847804.png)

2. 启动用于回调的测试服务,其中包含如下web接口

   ![1642609105185](src/docs/images/1642609105185.png)

3. Postman测试

   1. 不触发任务和返回值

      ![1642346520482](src/docs/images/1642346520482.png)

   2. 触发ResultA

      ![1642348536310](src/docs/images/1642348536310.png)

      ![1642349878557](src/docs/images/1642349878557.png)

   3. 触发ResultB

      ![1642348680982](src/docs/images/1642348680982.png)

   4. 触发Task,ResultB

      ![1642349083316](src/docs/images/1642349083316.png)

      ![1642349704066](src/docs/images/1642349704066.png)
...
4. 查看日志
   ...
   1. task日志，仅打印task执行线程的日志
      ...
      ![1642350151744](src/docs/images/1642350151744.png)

      ![1642350168316](src/docs/images/1642350168316.png)

   2. 项目日志，打印项目的全部日志

      ![1642350192452](src/docs/images/1642350192452.png)

      ![1642350210109](src/docs/images/1642350210109.png)
